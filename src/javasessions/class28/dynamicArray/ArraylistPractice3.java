...
public class ArraylistPractice3 {
	...
	public static void main(String[] args) {
		...
		Double d=12.00;//value 12 gives an error, this is applicable to AL of type Double
		double d1=12;//whereas in double primitive datatype, it can hold integer 
		...
		numList.add(null);//null can be allowed in non primitive ArrayList of type Integer(classes can hold null as they are non primitives)
...
//		System.out.println(studentList);
		...
		//footerList.add(8,"Naveen");//IndexOutOfBoundException
		//footerList.add(0,"Naveen");//Naveen will be on the 0th location and the others will be shifted to the next index(updation wont happen)
		//this will be adding the value
		
		footerList.set(0, "Himani");
		//this will be updating the value
